...
exports.RENDER = exports.NODESOCK = exports.SERVER = exports.PUPPETEER = exports.destroyMediator = exports.initMediator = void 0;
const tslib_1 = require("tslib");
const index_1 = tslib_1.__importDefault(require("../pup/index"));
const index_2 = tslib_1.__importDefault(require("../server/index"));
const sock_node_1 = tslib_1.__importDefault(require("../sock/sock_node"));
...
function destroyMediator() {
    PUPPETEER.destroy();
    SERVER.destroy();
    NODESOCK.destroy();
    exports.RENDER = RENDER = null;
}
exports.destroyMediator = destroyMediator;
