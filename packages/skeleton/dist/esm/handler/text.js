import { getComputedStyle, px2relativeUtil, getTextWidth, setOpacity, addClassName, cleanText } from '../util';
...
function textHandler(ele, { color }, cssUnit, decimal) {
    ...
    const { paddingTop, paddingRight, paddingBottom, paddingLeft, position: pos, fontSize, textAlign, wordSpacing, wordBreak } = comStyle;
